...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `new_projects` SET `service_name`='$service_name',`no_of_items`='$no_of_items',`customer_name`='$customer_name',`email`='$email',`contact_number`='$contact_number'  WHERE id = $id";
...
<body>
  ...
  <div class="container">
    ...
    <?php
    $sql = "SELECT * FROM `new_projects` WHERE id = $id LIMIT 1";
    $result = mysqli_query($conn, $sql);
